...
import com.takpap.youngmap.utils.EventHandler;
...
public class GuideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = mRouteGuideManager.onCreate(this, mOnNavigationListener,null, params);
        if (view != null) {
            setContentView(view);
        }
    ...
    private void showOverlay() {
        BNOverlayItem item =
                new BNOverlayItem(2563047.686035, 1.2695675172607E7, BNOverlayItem.CoordinateType
                        .BD09_MC);
        BNItemizedOverlay overlay = new BNItemizedOverlay( GuideActivity.this.getResources().getDrawable(R.drawable.navi_guide_turn));
